...
function articleCardHtml(a) {
  ...
  return `<a class="article-card" href="#/article/${a.id}">
...
function articleRowHtml(a) {
  const cat = getCategory(a.category);
  return `<a class="article-row" href="#/article/${a.id}">
...
function renderQA() {
  app.innerHTML = `
    <div class="qa-page">
      ...
      <h1>问答社区正在建设中</h1>
      <p>目前有任何问题，可以先在群内提问。这里以后会变成大家可以直接发帖、回答、讨论的地方。</p>
      <div class="qa-roadmap">
        <h4>接下来会陆续加入</h4>
        <ul>
          <li>用户注册与登录</li>
          <li>发帖 / 提问</li>
      ...
      <div class="back-row" style="justify-content:center; margin-top:40px;">
        <a href="#/">← 回到首页</a>
      </div>
    </div>
  `;
